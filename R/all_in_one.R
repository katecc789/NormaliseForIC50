...
#' @param control_neg The column which negative/cell control are located (column number from left, integer,default=1)
#' @param control_pos The column which positive/cell control are located (column number from left, integer,default=2)
