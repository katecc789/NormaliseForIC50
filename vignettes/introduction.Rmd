...
```{r setting up files}
input_file <- "Validation/2022-09-04_reads/example1.xlsx" #CHANGE to example file in your directory for troubleshooting
input_directory = "Validation/2022-09-04_reads/" #CHANGE this to directory of input .xlsx data files
