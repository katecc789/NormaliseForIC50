...
1. Clone (Make a copy) of this directory in your local system
2. Move all the Promega read .xlsx files into the same folder (your `input_directory`)
3. In the `import_neuts.R` script, Change the `input_directory`, `input_file` and `output_file` to appropriate names
...
4. Run `import_neuts.R` from start to finish
